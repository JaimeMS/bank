...
export class TransferenciaServico {
  ...
  public async transferir(dto: TransferenciaDTO): Promise<string> {
    if (stryMutAct_9fa48("2")) {
      ...
      if (stryMutAct_9fa48("5") ? contaOrigem !== undefined : stryMutAct_9fa48("4") ? false : stryMutAct_9fa48("3") ? true : (stryCov_9fa48("3", "4", "5"), contaOrigem === undefined)) throw new NegocioErro(stryMutAct_9fa48("6") ? "" : (stryCov_9fa48("6"), "conta de origem não encontrada"));
      if (stryMutAct_9fa48("9") ? contaDestino !== undefined : stryMutAct_9fa48("8") ? false : stryMutAct_9fa48("7") ? true : (stryCov_9fa48("7", "8", "9"), contaDestino === undefined)) throw new NegocioErro(stryMutAct_9fa48("10") ? "" : (stryCov_9fa48("10"), "conta de destino não encontrada"));
